	...
	public static void main(String args[])
	{
		...
		do
		{
			...
			switch(opt)
			{
				...
				d.addLast(ele);
				break;
				case 3:System.out.println("Deleted first element is "+d.deleteFirst());
				break;
				case 4:System.out.println("Deleted lasst element is "+d.deleteLast());
				break;
				case 5:System.out.println("Elements are ");
				d.display();
				break;
				case 6:System.out.println("Size is "+d.size());
				break;
				case 7:
				break;
