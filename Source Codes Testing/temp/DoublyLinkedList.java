	...
	public static void main(String args[])
	{
		...
		do
		{
			...
			switch(opt)
			{
				...
				break;
				case 5:System.out.println("Enter element value to insert after that element");
                                    int r=s.nextInt();
				...
				System.out.println("Enter element value to insert before that element");
                                 ...
                                 l.insertBefore(a,b);
				break;
				case 7:System.out.println("Enter element value to delete after that element ");
				                int c=s.nextInt();
                                int u=l.deleteAfter(c);
                                System.out.println("Deleted element is "+u);
				break;
				case 8:System.out.println("Enter element value to deletebefore that element");
                                 int d=s.nextInt();
				...
				l.reverse();
				break;
				case 11:System.out.println("Size is "+l.size());
				break;
				case 12:
				break;
			}
